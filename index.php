            ...
            <?php else : ?>
              ...
              <div class="post" id="post-<?php the_ID(); ?>">
                <div class="postcontents">
                  ...
                  <?php the_content('Read more &gt;'); ?>
                  <p><?php wp_link_pages('next_or_number=number&pagelink=page %'); ?></p>
                </div><!-- end postcontents -->
                <div class="postmeta">
                  <p>
                    <?php the_tags('Tags: ', ', ', ' | '); ?> <?php the_category(', ') ?> | <a href="<?php the_permalink() ?>">Permalink</a> |  <?php comments_popup_link('Leave a comment', '1 Comment', '% Comments'); ?> | <?php edit_post_link('Edit', ' ', ' | '); ?> Posted <?php the_date() ?> by  <?php the_author_link(); ?>
                  </p>
                </div><!-- end postmeta -->
